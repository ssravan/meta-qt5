...
Headers = ${BASEPKG_HOST_SYS}${layout_prefix}/include/qt5
Plugins = ${BASEPKG_HOST_SYS}${layout_prefix}/lib/qt5/plugins/
Mkspecs = ${BASEPKG_HOST_SYS}${layout_prefix}/share/qt5/mkspecs/
EOF
}
